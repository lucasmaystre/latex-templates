\documentclass[12pt,paper=a4,pagesize,abstracton]{scrartcl}
% In case a smaller font size is needed: use the package fullpage.
%\usepackage{fullpage}
\usepackage{lmodern} % Fonts. Needed because of the packages below.
...
\hypersetup{
  colorlinks=false,
  pdfauthor={Lucas Maystre},
  pdftitle={Pairwise Comparisons, Myth or Reality?}
}
